...
using Minimalhr_ms.Web.Domain.CartAggregate.Specifications;
using Minimalhr_ms.Web.Domain.GuestUserAggregate;
using Minimalhr_ms.Web.Domain.GuestUserAggregate.Specifications;
using Minimalhr_ms.Web.Domain.OrderAggregate;
using Minimalhr_ms.Web.Domain.ProductAggregate;

namespace Minimalhr_ms.Web.CartFeatures.Checkout;
