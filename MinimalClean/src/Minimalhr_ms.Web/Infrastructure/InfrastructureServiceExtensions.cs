...
using Minimalhr_ms.Web.Infrastructure.Data;
using Minimalhr_ms.Web.Infrastructure.Data.Queries;
using Minimalhr_ms.Web.ProductFeatures.List;
using Microsoft.EntityFrameworkCore;

namespace Minimalhr_ms.Web.Infrastructure;
